...
import com.apachat.loadingbutton.core.animatedDrawables.ProgressType
import com.apachat.loadingbutton.core.presentation.State
import com.apachat.loadingbutton.core.updateHeight
import com.apachat.loadingbutton.core.updateWidth
import com.apachat.loadingbutton.core.utils.addLifecycleObserver
import com.apachat.loadingbutton.core.utils.parseGradientDrawable
...
internal fun ProgressButton.config(tArray: TypedArray) {
  ...
  spinningBarColor =
    tArray.getColor(R.styleable.CircularProgressButton_spinning_bar_color, spinningBarColor)
